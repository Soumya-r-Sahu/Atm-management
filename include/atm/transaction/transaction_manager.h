...
TransactionResult performBillPayment(int cardNumber, const char* billerID, float amount, const char* username); // Added bill payment function
...
TransactionResult performVirtualBillPayment(const char* cardNumber, int cvv, const char* expiryDate, 
                                           const char* billerID, float amount, const char* username); // Added virtual bill payment function
