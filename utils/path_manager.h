...
/**
 * @file path_manager.h
 * @brief Legacy path management utilities for the Core Banking System
 * @deprecated This file is deprecated. Use unified_paths.h instead.
 * 
 * This file is maintained for backward compatibility only.
 * New code should use include/common/unified_paths.h which provides
 * a standardized approach to path management.
 */
