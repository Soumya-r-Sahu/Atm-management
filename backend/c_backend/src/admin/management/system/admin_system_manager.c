...
bool view_system_logs(AdminUser* admin) {
    ...
    writeSecurityLog("ADMIN", auditMessage);
...
bool manage_system_config(AdminUser* admin) {
    ...
    if (!admin_has_role(admin, "SuperAdmin")) {
        ...
        writeSecurityLog("SECURITY", "Unauthorized attempt to access system configuration");
        return false;
    }
    ...
    // Log the activity
    writeSecurityLog("ADMIN", "Managed system configuration");
    return true;
}
...
static void edit_transaction_limits(AdminUser* admin) {
    ...
    writeSecurityLog("ADMIN", logMessage);
...
bool backup_system_data(AdminUser* admin) {
    ...
    if (!admin_has_role(admin, "SuperAdmin")) {
        ...
        writeSecurityLog("SECURITY", "Unauthorized attempt to perform system backup");
        return false;
    }
